package com.downloader.twotwo.video.services.youtube.dashmanifestcreators;

import com.downloader.twotwo.video.downloader.Response;
import com.downloader.twotwo.video.services.youtube.DeliveryType;
import com.downloader.twotwo.video.services.youtube.ItagItem;
import com.downloader.twotwo.video.utils.ManifestCreatorCache;
...
import static com.downloader.twotwo.video.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.ALR_YES;
import static com.downloader.twotwo.video.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.RN_0;
import static com.downloader.twotwo.video.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SEGMENT_TIMELINE;
import static com.downloader.twotwo.video.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SQ_0;
import static com.downloader.twotwo.video.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.buildAndCacheResult;
import static com.downloader.twotwo.video.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateDocumentAndDoCommonElementsGeneration;
import static com.downloader.twotwo.video.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTemplateElement;
import static com.downloader.twotwo.video.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTimelineElement;
import static com.downloader.twotwo.video.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.getInitializationResponse;
import static com.downloader.twotwo.video.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.setAttribute;
import static com.downloader.twotwo.video.utils.Utils.EMPTY_STRING;
import static com.downloader.twotwo.video.utils.Utils.isBlank;
