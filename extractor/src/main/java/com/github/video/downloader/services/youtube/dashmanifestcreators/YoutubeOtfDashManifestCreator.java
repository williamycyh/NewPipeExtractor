package com.github.video.downloader.services.youtube.dashmanifestcreators;

import com.github.video.downloader.downloader.Response;
import com.github.video.downloader.services.youtube.DeliveryType;
import com.github.video.downloader.services.youtube.ItagItem;
import com.github.video.downloader.utils.ManifestCreatorCache;
...
import static com.github.video.downloader.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.ALR_YES;
import static com.github.video.downloader.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.RN_0;
import static com.github.video.downloader.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SEGMENT_TIMELINE;
import static com.github.video.downloader.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SQ_0;
import static com.github.video.downloader.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.buildAndCacheResult;
import static com.github.video.downloader.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateDocumentAndDoCommonElementsGeneration;
import static com.github.video.downloader.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTemplateElement;
import static com.github.video.downloader.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTimelineElement;
import static com.github.video.downloader.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.getInitializationResponse;
import static com.github.video.downloader.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.setAttribute;
import static com.github.video.downloader.utils.Utils.EMPTY_STRING;
import static com.github.video.downloader.utils.Utils.isBlank;
