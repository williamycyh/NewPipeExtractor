...
import com.github.video.downloader.exceptions.SoundCloudGoPlusContentException;
...
public class SoundcloudStreamExtractor extends StreamExtractor {
    ...
    public void onFetchPage(@Nonnull final Downloader downloader) throws IOException,
        ...
        final String policy = track.getString("policy", Utils.EMPTY_STRING);
    ...
    @Override
    public String getId() {
        return track.getInt("id") + Utils.EMPTY_STRING;
    }
    ...
    public String getThumbnailUrl() {
        String artworkUrl = track.getString("artwork_url", Utils.EMPTY_STRING);
        if (artworkUrl.isEmpty()) {
            artworkUrl = track.getObject("user").getString("avatar_url", Utils.EMPTY_STRING);
        }
    ...
    private static String getSingleUrlFromHlsManifest(final String hlsManifestUrl)
        ...
        for (int l = lines.length - 1; l >= 0; l--) {
            ...
            if (line.trim().length() != 0 && !line.startsWith("#") && line.startsWith("https")) {
                ...
                return Utils.HTTPS + hlsLastRangeUrlArray[2] + "/media/0/" + hlsLastRangeUrlArray[5]
    ...
    private static String urlEncode(final String value) {
        try {
            return URLEncoder.encode(value, Utils.UTF_8);
