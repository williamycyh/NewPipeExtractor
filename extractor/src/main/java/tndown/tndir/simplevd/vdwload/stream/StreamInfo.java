package tndown.tndir.simplevd.vdwload.stream;

import tndown.tndir.simplevd.vdwload.utils.DashMpdParser;
import tndown.tndir.simplevd.vdwload.Info;
...
public class StreamInfo extends Info {
    ...
    private static StreamInfo extractImportantData(final StreamExtractor extractor)
        ...
        if (streamType == StreamType.NONE || Utils.isNullOrEmpty(url) || Utils.isNullOrEmpty(id)
    ...
    private static void extractStreams(final StreamInfo streamInfo, final StreamExtractor extractor)
        ...
        if (!Utils.isNullOrEmpty(streamInfo.getDashMpdUrl())) {
            try {
