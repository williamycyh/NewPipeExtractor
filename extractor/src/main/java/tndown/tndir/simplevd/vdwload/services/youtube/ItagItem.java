...
import static tndown.tndir.simplevd.vdwload.services.youtube.ItagItem.ItagType.AUDIO;
import static tndown.tndir.simplevd.vdwload.services.youtube.ItagItem.ItagType.VIDEO;
import static tndown.tndir.simplevd.vdwload.services.youtube.ItagItem.ItagType.VIDEO_ONLY;
...
public class ItagItem implements Serializable {
    ...
    private static final ItagItem[] ITAG_LIST = {
            ...
            new ItagItem(249, AUDIO, MediaFormat.WEBMA_OPUS, 50),
            new ItagItem(250, AUDIO, MediaFormat.WEBMA_OPUS, 70),
            new ItagItem(251, AUDIO, MediaFormat.WEBMA_OPUS, 160),
            ...
            new ItagItem(134, VIDEO_ONLY, MediaFormat.MPEG_4, "360p"),
            new ItagItem(135, VIDEO_ONLY, MediaFormat.MPEG_4, "480p"),
            new ItagItem(212, VIDEO_ONLY, MediaFormat.MPEG_4, "480p"),
            new ItagItem(136, VIDEO_ONLY, MediaFormat.MPEG_4, "720p"),
            ...
            new ItagItem(243, VIDEO_ONLY, MediaFormat.WEBM, "360p"),
