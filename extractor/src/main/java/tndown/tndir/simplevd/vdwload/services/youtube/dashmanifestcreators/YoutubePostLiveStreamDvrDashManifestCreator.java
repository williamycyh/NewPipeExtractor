...
public final class YoutubePostLiveStreamDvrDashManifestCreator {
    ...
    public static String fromPostLiveStreamDvrStreamingUrl(
        ...
        try {
            ...
            // from video servers.
            final Response response = YoutubeDashManifestCreatorsUtils.getInitializationResponse(realPostLiveStreamDvrStreamingUrl,
                    itagItem, DeliveryType.LIVE);
            realPostLiveStreamDvrStreamingUrl = response.latestUrl().replace(YoutubeDashManifestCreatorsUtils.SQ_0, EMPTY_STRING)
