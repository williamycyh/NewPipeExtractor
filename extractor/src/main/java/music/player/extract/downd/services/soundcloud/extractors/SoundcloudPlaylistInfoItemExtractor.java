...
import music.player.extract.downd.playlist.PlaylistInfoItemExtractor;
...
public class SoundcloudPlaylistInfoItemExtractor implements PlaylistInfoItemExtractor {
    ...
    public String getThumbnailUrl() throws ParsingException {
        ...
        if (itemObject.isString(ARTWORK_URL_KEY)) {
            final String artworkUrl = itemObject.getString(ARTWORK_URL_KEY, Utils.EMPTY_STRING);
        ...
        try {
            ...
            for (final Object track : itemObject.getArray("tracks")) {
                ...
                if (trackObject.isString(ARTWORK_URL_KEY)) {
                    final String artworkUrl = trackObject.getString(ARTWORK_URL_KEY, Utils.EMPTY_STRING);
                    if (!artworkUrl.isEmpty()) {
                        // An artwork URL with a better resolution
                        return artworkUrl.replace("large.jpg", "crop.jpg");
                    }
                ...
                final String creatorAvatar = creator.getString(AVATAR_URL_KEY, Utils.EMPTY_STRING);
        ...
        try {
            ...
            return itemObject.getObject(USER_KEY).getString(AVATAR_URL_KEY, Utils.EMPTY_STRING);
