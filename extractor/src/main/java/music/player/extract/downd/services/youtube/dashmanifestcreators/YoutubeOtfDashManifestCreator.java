package music.player.extract.downd.services.youtube.dashmanifestcreators;

import music.player.extract.downd.downloader.Response;
import music.player.extract.downd.services.youtube.DeliveryType;
import music.player.extract.downd.services.youtube.ItagItem;
import music.player.extract.downd.utils.ManifestCreatorCache;
...
import static music.player.extract.downd.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.ALR_YES;
import static music.player.extract.downd.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.RN_0;
import static music.player.extract.downd.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SEGMENT_TIMELINE;
import static music.player.extract.downd.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SQ_0;
import static music.player.extract.downd.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.buildAndCacheResult;
import static music.player.extract.downd.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateDocumentAndDoCommonElementsGeneration;
import static music.player.extract.downd.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTemplateElement;
import static music.player.extract.downd.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTimelineElement;
import static music.player.extract.downd.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.getInitializationResponse;
import static music.player.extract.downd.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.setAttribute;
import static music.player.extract.downd.utils.Utils.EMPTY_STRING;
import static music.player.extract.downd.utils.Utils.isBlank;
