...
import music.player.extract.downd.comments.CommentsInfoItemExtractor;
...
public class YoutubeCommentsInfoItemExtractor implements CommentsInfoItemExtractor {
    ...
    public String getTextualUploadDate() throws ParsingException {
        try {
            return YoutubeParsingHelper.getTextFromObject(JsonUtils.getObject(getCommentRenderer(),
                    "publishedTimeText"));
        } catch (final Exception e) {
    ...
    public String getCommentText() throws ParsingException {
        try {
            ...
            final String commentText = YoutubeParsingHelper.getTextFromObject(contentText);
